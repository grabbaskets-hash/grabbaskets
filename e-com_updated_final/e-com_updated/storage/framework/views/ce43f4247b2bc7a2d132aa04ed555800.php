        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <a href="<?php echo e(url('/admin/dashboard')); ?>" class="btn btn-light me-2">
                        <i class="fas fa-arrow-left"></i> Back to Dashboard
                    </a>
                    <a href="<?php echo e(url('/admin/orders')); ?>" class="btn btn-outline-light">
    ...
    <div class="container mt-4">
        ...
        <div class="quick-stats">
            <div class="row text-center">
                <div class="col-md-3">
                    <h3><?php echo e(\App\Models\User::where('role', 'buyer')->count()); ?></h3>
                    <p>Total Buyers</p>
                </div>
                <div class="col-md-3">
                    <h3><?php echo e(\App\Models\User::where('role', 'seller')->count()); ?></h3>
                    <p>Total Sellers</p>
                </div>
                <div class="col-md-3">
                    <h3><?php echo e(\App\Models\Product::where('discount', '>', 0)->count()); ?></h3>
                    <p>Products on Sale</p>
                </div>
                <div class="col-md-3">
                    <h3><?php echo e(\App\Models\Notification::where('created_at', '>=', now()->today())->count()); ?></h3>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $recentNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <span class="badge bg-primary"><?php echo e(ucfirst(str_replace('_', ' ', $notification->type))); ?></span>
                                            </td>
                                            <td><?php echo e($notification->title); ?></td>
                                            <td>
                                                <i class="fas fa-users"></i> <?php echo e($notification->recipient_count); ?> users
                                            </td>
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/admin/promotional-notifications.blade.php ENDPATH**/ ?>
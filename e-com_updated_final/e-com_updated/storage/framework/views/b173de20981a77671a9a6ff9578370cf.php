    ...
    <div class="container">
        <div class="tracking-container">
            ...
            <div class="quick-track">
                ...
                <a href="<?php echo e(route('orders.track')); ?>" class="btn btn-outline-primary btn-sm">
            ...
            <div class="tracking-form">
                <form id="trackingForm" method="POST" action="<?php echo e(route('tracking.track')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" id="courier" name="courier">
                                ...
                                <?php $__currentLoopData = $supportedCouriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/tracking/form.blade.php ENDPATH**/ ?>
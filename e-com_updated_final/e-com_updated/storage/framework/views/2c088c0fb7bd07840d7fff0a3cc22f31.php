...
<body>
    ...
    <div class="sidebar" id="sidebarMenu">
        ...
        <ul class="nav nav-pills flex-column">
            <li><a class="nav-link active" href="<?php echo e(route('admin.dashboard')); ?>"><i class="bi bi-speedometer2"></i>
                    Dashboard</a></li>
            <li><a class="nav-link " href="<?php echo e(route('admin.products')); ?>"><i class="bi bi-box-seam"></i>
                    Products</a></li>
            <li><a class="nav-link" href="<?php echo e(route('admin.orders')); ?>"><i class="bi bi-cart-check"></i> Orders</a></li>
            <li><a class="nav-link" href="<?php echo e(route('tracking.form')); ?>"><i class="bi bi-truck"></i> Track Package</a></li>
            <li><a class="nav-link" href="<?php echo e(route('admin.manageuser')); ?>"><i class="bi bi-people"></i> Users</a></li>
            <li><a class="nav-link" href="<?php echo e(route('admin.promotional.form')); ?>"><i class="bi bi-bell-fill"></i> Promotional Notifications</a></li>
            <li><a class="nav-link" href="<?php echo e(route('admin.sms.dashboard')); ?>"><i class="bi bi-chat-dots"></i> SMS Management</a></li>
            <li><a class="nav-link" href="<?php echo e(route('admin.bulkProductUpload')); ?>"><i class="bi bi-upload"></i> Bulk
                    Product Upload</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="card stat-card text-center p-3 bg-light">
                        ...
                        <p class="display-6 fw-bold"><?php echo e($ordersCount->count()); ?></p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card stat-card text-center p-3 bg-light">
                        ...
                        <p class="display-6 fw-bold"><?php echo e($sellersCount); ?></p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card stat-card text-center p-3 bg-light">
                        ...
                        <p class="display-6 fw-bold"><?php echo e($buyersCount); ?></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body text-white">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <a href="<?php echo e(route('admin.promotional.form')); ?>" class="btn btn-light btn-lg">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-light text-dark"><?php echo e($ordersCount->count()); ?> Orders</span>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-hover table-bordered align-middle">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $ordersCount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-dark"><?php echo e($order->payment_method); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td><i class="bi bi-calendar-event"></i>
                                        <?php echo e($order->created_at->format('d M Y, h:i A')); ?></td>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('admin.updateTracking', $order->id)); ?>"
                                            class="d-flex gap-2 align-items-center">
                                            <?php echo csrf_field(); ?>
                                            <input type="text" name="tracking_number" class="form-control form-control-sm"
                                                placeholder="Tracking #" value="<?php echo e($order->tracking_number); ?>">
                                            <button type="submit" class="btn btn-sm btn-outline-success">Save</button>
                                        </form>
                                        <?php if($order->tracking_number): ?>
                                            <div class="mt-1 text-success small">Tracking #:
                                                <strong><?php echo e($order->tracking_number); ?></strong>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
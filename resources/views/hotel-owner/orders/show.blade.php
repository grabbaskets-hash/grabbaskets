                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if($item->foodItem && $item->foodItem->image)
                                                <img src="{{ $item->foodItem->first_image_url }}" alt="{{ $item->food_name }}" class="rounded me-3" style="width: 48px; height: 48px; object-fit: cover;">
                                            @endif
                                            <div>
                                                <h6 class="mb-0">{{ $item->food_name ?? ($item->foodItem->name ?? 'Unknown Item') }}</h6>

            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('hotel-owner.food-items.edit', $foodItem) }}"
                            ...
                            <div class="col-md-{{ $foodItem->image ? '6' : '12' }}">
                                <div class="mb-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span
                                            class="badge bg-{{ $foodItem->food_type == 'veg' ? 'success' : 'danger' }} me-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <span
                                            class="badge bg-secondary">{{ ucfirst(str_replace('_', ' ', $foodItem->category)) }}</span>
                                    </div>
                                    <div class="col-6">
                                        <strong>Price:</strong><br>
                                        <span
                                            class="h5 text-primary">₹{{ number_format($foodItem->getFinalPrice(), 2) }}</span>
                                        @if($foodItem->discounted_price)
                                            <br><small
                                                class="text-muted"><del>₹{{ number_format($foodItem->price, 2) }}</del></small>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <form action="{{ route('hotel-owner.food-items.update', $foodItem) }}" method="POST"
                                ...
                                <button type="submit"
                                    class="btn btn-{{ $foodItem->is_available ? 'warning' : 'success' }} btn-sm w-100">
                            ...
                            <form action="{{ route('hotel-owner.food-items.update', $foodItem) }}" method="POST"
                                ...
                                <input type="hidden" name="food_type" value="{{ $foodItem->food_type }}">
                                <button type="submit"
                                    class="btn btn-{{ $foodItem->is_popular ? 'outline-warning' : 'warning' }} btn-sm w-100">

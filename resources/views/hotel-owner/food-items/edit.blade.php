            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('hotel-owner.food-items.show', $foodItem) }}"
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('hotel-owner.food-items.update', $foodItem) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                                        id="price" name="price" value="{{ old('price', $foodItem->price) }}" step="0.01"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('discounted_price', $foodItem->discounted_price) }}" step="0.01"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('preparation_time', $foodItem->preparation_time) }}" min="1"
                                        placeholder="15">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('food_type') is-invalid @enderror" id="food_type"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('serves') is-invalid @enderror"
                                        id="serves" name="serves" value="{{ old('serves', $foodItem->serves) }}" min="1"
                                        placeholder="1">
                                    @error('serves')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('allergens') is-invalid @enderror"
                                    id="allergens" name="allergens" value="{{ old('allergens', $foodItem->allergens) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Upload a new image to replace the current one (JPG, PNG, max 2MB)
                                </div>
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_available"
                                            name="is_available" value="1" {{ old('is_available', $foodItem->is_available) ? 'checked' : '' }}>

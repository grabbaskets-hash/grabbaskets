                ...
                @foreach($foodItems as $item)
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            {{-- IMAGE --}}
                            @if($item->image)
                                <img src="{{ $item->first_image_url }}" class="card-img-top" style="height:200px; object-fit:contain;"
                                    alt="{{ $item->name }}">
                            @else
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <div class="btn-group w-100">
                                        ...
                                        <form action="{{ route('hotel-owner.food-items.destroy', $item->id) }}" method="POST"

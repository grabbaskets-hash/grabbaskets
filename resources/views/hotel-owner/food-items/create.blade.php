        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4><i class="fas fa-plus-circle me-2"></i>Add New Food Item</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('hotel-owner.food-items.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                    ...
                                    <option value="appetizer" {{ old('category') == 'staters' ? 'selected' : '' }}>Staters</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Describe your food item...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('food_type') is-invalid @enderror" id="food_type" name="food_type" required>
                                    ...
                                    <option value="veg" {{ old('food_type') == 'veg' ? 'selected' : '' }}>Vegetarian</option>
                                    <option value="non_veg" {{ old('food_type') == 'non_veg' ? 'selected' : '' }}>Non-Vegetarian</option>
                                </select>
                                @error('food_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('ingredients') is-invalid @enderror" 
                                      ...
                                      name="ingredients" 
                                      rows="3"
                                      placeholder="List main ingredients (comma separated)">{{ old('ingredients') }}</textarea>
                            @error('ingredients')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" 
                                   ...
                                   name="image" 
                                   accept="image/*">
                            <div class="form-text">Upload an image of your food item (JPG, PNG, max 2MB)</div>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

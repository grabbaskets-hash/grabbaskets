  ...
  <style>
    ...
    * {
    ...
    .category-pills-modern {
      ...
      top: 72px;
      z-index: 100;
      /* Lower z-index to not interfere with modals */
    }
    ...
    .category-pills-modern {
      z-index: 100;
      /* Lower than navbar, won't interfere with modals */
    }
                      ...
                      <div class="d-flex gap-2">
                        ...
                        <div class="dropdown" onclick="event.stopPropagation();">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end shadow-lg" style="background: #1a1a3e; border: 1px solid rgba(0, 255, 255, 0.3); border-radius: 12px;">
                            ...
                            <li>
                              <hr class="dropdown-divider" style="border-color: rgba(0, 255, 255, 0.2);">
                            </li>
  ...
  {{-- </section> --}}
    ...
    <script>
      ...
      function showEnhancedVoiceNotification(message, gender) {
        ...
        setTimeout(() => {
          notification.style.animation = 'slideOutEnhanced 0.8s ease-in forwards';
    ...
    <script>
      ...
      function createMobileAuthPopup() {
        ...
        login ') }}" class="mobile-popup-item">' +
          ...
          '<a href="{{ route('
        register ') }}" class="mobile-popup-item">' +
          ...
          '<a href="{{ route('
        hotel - owner.register ') }}" class="mobile-popup-item featured">' +
          ...
          '<a href="{{ route('
        delivery - partner.register ') }}" class="mobile-popup-item">' +
      ...
      function createMobileFoodPopup() {
        ...
        popup.innerHTML =
          ...
          '<div class="mobile-popup-content">' +
          '<a href="{{ route('
        products.index ') }}?category=food" class="mobile-popup-item">' +
          ...
          '<a href="{{ route('
        cart.index ') }}" class="mobile-popup-item">' +
    ...
    `;
      ...
      function updateWishlistBadge() {
        fetch('/wishlist/count', {
          ...
          .then(response => response.json())
          .then(data => {
            const wishlistNavItem = document.querySelector('a[href="{{ route('
              wishlist.index ') }}"]');
            if (wishlistNavItem) {

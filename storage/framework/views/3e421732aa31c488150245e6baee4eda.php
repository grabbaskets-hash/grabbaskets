...
<div class="container-card">
    ...
    <div class="right-box">
        ...
        <form method="POST" action="<?php echo e(route('seller.storeCategorySubcategory')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php $__errorArgs = ['category_unique_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <select id="existing_category_id" name="existing_category_id" class="form-select">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cat->unique_id); ?>"><?php echo e($cat->unique_id); ?> (<?php echo e($cat->name); ?>)</option>
            ...
            <select id="existing_category" name="existing_category" class="form-select">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?> (ID: <?php echo e($cat->unique_id); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/seller/create-category-subcategory.blade.php ENDPATH**/ ?>
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1><?php echo e(config('app.name', 'E-Commerce')); ?></h1>
        ...
        <div class="content">
            <div class="greeting">
                Hi <?php echo e($user->name ?? 'Valued Customer'); ?>! 👋
            </div>

            <div class="main-message">
                <h2><?php echo e($title ?? 'Special Offer'); ?></h2>
                <p><?php echo e($message ?? 'We have amazing deals waiting for you!'); ?></p>
            </div>

            <?php if(isset($promotionData['type']) && $promotionData['type'] === 'flash_sale'): ?>
            ...
            <?php if(isset($promotionData['type']) && $promotionData['type'] === 'daily_deals'): ?>
                <div style="text-align: center;">
            ...
            <?php if(isset($promotionData['type']) && $promotionData['type'] === 'weekly_newsletter'): ?>
                <div style="text-align: center;">
                    <p>📈 This Week's Highlights:</p>
                    <div style="background: #e8f5e8; padding: 1rem; border-radius: 8px; margin: 1rem 0;">
                        <p style="margin: 0;">
                            ✅ <?php echo e($promotionData['new_products_count'] ?? 0); ?> New Products Added<br>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong><?php echo e(config('app.name', 'E-Commerce') ?? 'GRAB BASKETS'); ?></strong></p>
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/emails/promotional.blade.php ENDPATH**/ ?>
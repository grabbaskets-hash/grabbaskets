...
<div class="container-card">
    ...
    <div class="right-box">
        ...
        <form method="POST" action="<?php echo e(route('seller.storeProduct')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row g-3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" id="price" name="price" class="form-control" required value="<?php echo e(old('price')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" id="discount" name="discount" class="form-control" value="<?php echo e(old('discount')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" id="delivery_charge" name="delivery_charge" class="form-control" value="<?php echo e(old('delivery_charge')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <select id="gift_option" name="gift_option" class="form-select" required>
                        ...
                        <option value="yes" <?php echo e(old('gift_option') == 'yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="no" <?php echo e(old('gift_option') == 'no' ? 'selected' : ''); ?>>No</option>
                    </select>
                    <?php $__errorArgs = ['gift_option'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="stock" name="stock" class="form-control" min="0" required value="<?php echo e(old('stock')); ?>">
...
</html><?php /**PATH E:\e-com_updated_final\e-com_updated\resources\views/seller/create-product.blade.php ENDPATH**/ ?>